...
public class InventoryPage extends BasePage {
	...
	private final By txt_FirstProductName = By.xpath("(//div[@data-test='inventory-item-name'])[1]");
	private final By txt_FirstProductPrice = By.xpath("(//div[@data-test='inventory-item-price'])[1]");
	private final By link_X = By.xpath("//a[normalize-space()='Twitter']");
	private final By link_Facebook = By.xpath("//a[normalize-space()='Facebook']");
	...
	public String verifyFirstProductName() {
		return getText(txt_FirstProductName);
		}
	
	public void clickFirstProduct() {
	click(txt_FirstProductName);
	}
	
	public String verifyFirstProductPrice() {
	return getText(txt_FirstProductPrice);
	}
	
//We have additional methods x and facebook for switching tabs	
	public void switchTabToX() {
	click(link_X);
	switchToNewWindow();
	}
	
	public void switchTabToFacebook() {
	click(link_Facebook);
	switchToNewWindow();
	}
